...
<div class="top-left-text">GOON 🐉</div>

<div class="video-container" id="videoContainer">

    <!-- Local videos will be added dynamically -->
    ...
    <!-- New Jumpshare Embed 1 (replaced) -->
    <div class="video-item" data-video="new_embed1">
        <div class="embed-wrapper">
            <iframe src="https://jumpshare.com/embed/LSDE8nM1U1xh1IIug0iy" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
        </div>
        <div class="title">New Embed 1</div>
        <button class="like-btn">❤️ 0</button>
    </div>

    <!-- New Jumpshare Embed 2 (replaced) -->
    <div class="video-item" data-video="new_embed2">
        <div class="embed-wrapper">
            <iframe src="https://jumpshare.com/embed/xbGv1TOSxl89b58FgEAY" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
        </div>
        <div class="title">New Embed 2</div>
        <button class="like-btn">❤️ 0</button>
    </div>
...
// ======= Load local videos dynamically =======
const localVideos = ["video1.mp4", "video2.mp4"]; // your existing videos
const localVideoElements = [];

localVideos.forEach((fileName, index) => {
    ...
    container.insertBefore(item, container.firstChild); // add local videos at top
    localVideoElements.push(video);
});

// Like buttons for Jumpshare videos
